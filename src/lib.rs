...
#[derive(Debug)]
pub struct NanoSpectralProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NanoSpectralProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NanoSpectral processing");
    
    let mut processor = NanoSpectralProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NanoSpectralProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NanoSpectralProcessor::new(false);
